...
const Deteles = ({ position, company, time, address, work }) => {
  ...
  return (
    <li
      ref={ref}
      className="py-8 first:pt-0 last:pb-0 md:w-[60%] w-[90%] mx-auto flex flex-col items-center justify-between"
    >
      <LiIcon reparens={ref} />
      <motion.div
        initial={{ y: 70 }}
...
const Expreneces = () => {
  ...
  return (
    <>
      <h2 className="lg:text-5xl md:text-4xl text-3xl font-bold md:mt-16 mt-5 w-full text-center mb-8 dark:text-light">
        EXPERIENCE
      </h2>
      ...
      >
        ...
        <div>
          <div className="py-6 lgl:py-12 font-titleFont flex flex-col gap-4">
            <h2 className="text-xl md:text-3xl dark:text-light font-bold">
              Education Quality
            </h2>
          </div>
        ...
        <div>
          <div className="py-6 lgl:py-12 font-titleFont flex flex-col gap-4">
            <h2 className="text-xl dark:text-light md:text-3xl font-bold">
              Job Experience
            </h2>
          </div>
          <div className="mt-6 lgl:mt-14 w-full  border-l-[6px] border-l-black dark:border-l-gray-700 border-opacity-30 flex flex-col gap-10">
            ...
            />
            <ResumeCard
              title="Front-End Developer (intran)"
              subTitle="Tech DSF - (2022 - 2023)"
              result="Thakurgaon"
              des=" I am currently working as a Frontend developer in tech DSF software company, where I successfully completed 3 projects."
            />
            <ResumeCard
            title="Front-end Developer"
            subTitle="softriple - (2023 - 2024)"
            result="Uttar Badda, dhaka-1212"
            des="I am currently working as a Frontend developer in Softriple software company, where I successfully completed 9 projects."
          />
          </div>
        </div>
      </motion.div>
