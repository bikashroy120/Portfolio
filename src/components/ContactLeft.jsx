...
const ContactLeft = () => {
  return (
    <div className="w-full lg:w-[35%] h-full bg-white/75 dark:bg-black shadow-md  p-4 lg:p-8 rounded-lg flex flex-col gap-5 justify-center">
      <Image
      ...
      <div className="flex flex-col gap-1">
        <h2 className="text-base uppercase dark:text-light font-titleFont">Find me in</h2>
