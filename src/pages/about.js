      ...
      <main className='flex flex-col w-full items-center justify-center'>
        <Layout className='pt-16'> 
            ...
            <div className='grid w-full grid-cols-8 gap-16 dark:text-light'>
                ...
                <div className=' col-span-3 bg-light border-2 border-solid border-dark dark:bg-dark dark:border-light rounded-2xl h-max p-8 relative'>
                ...
                <div className=' col-span-2 flex flex-col justify-between items-end'>
                    <div className='flex flex-col items-end justify-center'>
                      ...
                      <h2 className='text-xl font-medium text-dark/75 dark:text-light'>Satisfied Client</h2>
                    </div>
                    <div className='flex flex-col items-end justify-center'>
                      <span className=' text-7xl font-bold inline-block'><AnimitedNumber value={40}/>+</span>
                      <h2 className='text-xl font-medium text-dark/75 dark:text-light'>Projects Completed</h2>
                    </div>
                    <div className='flex flex-col items-end justify-center'>
                      <span className=' text-7xl font-bold inline-block'><AnimitedNumber value={5}/>+</span>
                      <h2 className='text-xl font-medium text-dark/75 dark:text-light'>Yeras Of Experience</h2>
                    </div>
                </div>
            </div>
            <Sckil/>
